...
do
    ...
    function InitEvents(Button)
        function WaitForEvent(event, timeout, validator)
            ...
            local connection = WhyIsSheLookingAtMe:Connection(event, function(...)
        ...
        WhyIsSheLookingAtMe:Connection(Button.Outer.InputBegan, function(Input)
        ...
        WhyIsSheLookingAtMe:Connection(Button.Outer.TouchTap, function()
            if Button.Locked then return end
            Library:SafeCallback(Button.Func)
        end)
    end
